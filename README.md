...
1. Open the [Releases page](https://github.com/mattytap/Sermon-Works/releases) and download `sermon-works-3.0.2.zip` from the latest release.
...
Latest tag: `3.0.2`. WordPress.org submission in queue; 3.0.2 supersedes 3.0 and 3.0.1.
