...
if ( have_posts() ) :
	...
	echo apply_filters( 'taxonomy-wpfc_service_type-before-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Theme/plugin extension point for HTML markup; sermon admins control filter implementations.
	...
	echo apply_filters( 'taxonomy-wpfc_service_type-after-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Theme/plugin extension point for HTML markup; sermon admins control filter implementations.
